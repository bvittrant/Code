...
d_MutByPatient = pd.read_table('results_files/SNP_count_mutation_by_patient_IGS.tsv')
...
fig.savefig("pictures/SNP_BP_BCR_IGS.png")
...
d_MutByPatient.groupby('BCR').boxplot(column=['mutation_counts'],
    ...
    flierprops = flierprops,  whiskerprops = whiskerprops, capprops = capprops)
plt.savefig("pictures/SNP_BP_GS_IGS.png")

d_MutByPatient.groupby('BCR').boxplot(column=['mutation_counts'],
    by='TNM',figsize=(10,8),boxprops=boxprops,medianprops=medianprops,showmeans=True,
    flierprops = flierprops,  whiskerprops = whiskerprops, capprops = capprops)
plt.savefig("pictures/SNP_BP_TNM_IGS.png")
...
fig.savefig("pictures/SNP_BP_MTBCR_IGS.png")
